package mon.sof.project.common.sysLog.advice;
...
import mon.sof.project.common.sysLog.service.SysLogService;
...
public class SysLogAdvice {
    ...
    private void createLog(JoinPoint joinPoint) {
        ...
        mon.sof.project.common.sysLog.entity.SysLog log = new mon.sof.project.common.sysLog.entity.SysLog();
