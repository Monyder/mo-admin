...
-- ----------------------------
INSERT INTO `sys_data_type` VALUES ('1', 'varchar', '10');
INSERT INTO `sys_data_type` VALUES ('2', 'bigint', '11');
INSERT INTO `sys_data_type` VALUES ('3', 'int', '12');
INSERT INTO `sys_data_type` VALUES ('4', 'date', '13');
INSERT INTO `sys_data_type` VALUES ('5', 'datetime', '14');
INSERT INTO `sys_data_type` VALUES ('6', 'timestamp', '15');
INSERT INTO `sys_data_type` VALUES ('7', 'float', '16');
INSERT INTO `sys_data_type` VALUES ('8', 'text', '17');
...
CREATE TABLE `sys_info_item` (
  ...
  `nullable` int(11) DEFAULT NULL COMMENT '可否为空 必填0是1否',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='信息项表';
...
CREATE TABLE `sys_info_set` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='信息集表';
...
INSERT INTO `sys_log` VALUES ('487', 'admin', '2020-12-14 10:18:56', '192.168.1.208', '角色管理', '修改权限', null, null, null);
INSERT INTO `sys_log` VALUES ('488', 'admin', '2020-12-14 10:43:58', '192.168.1.208', '角色管理', '修改权限', null, null, null);
INSERT INTO `sys_log` VALUES ('489', 'admin', '2020-12-14 10:45:07', '192.168.1.208', '角色管理', '修改权限', null, null, null);
INSERT INTO `sys_log` VALUES ('490', 'admin', '2020-12-14 10:45:07', '192.168.1.208', '角色管理', '修改权限', null, null, null);
INSERT INTO `sys_log` VALUES ('491', 'admin', '2020-12-15 16:16:20', '192.168.1.208', '角色管理', '修改权限', null, null, null);
INSERT INTO `sys_log` VALUES ('492', 'admin', '2020-12-16 16:50:28', '192.168.1.208', '菜单功能', '新增菜单操作', null, null, null);
INSERT INTO `sys_log` VALUES ('493', 'admin', '2020-12-16 16:51:37', '192.168.1.208', '菜单功能', '修改菜单操作', null, null, null);
...
INSERT INTO `sys_menu` VALUES ('7', '信息集管理', '2', '250', null, 'sysInfoSet', '/sys/sysInfoSet', 'el-icon-notebook-1', null, null, null, null);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('2', 'Admin', '系统管理员', '0', '1,2,3,4,5,6,7,', '0', null, '1');
